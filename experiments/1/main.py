...
trainset = LOLDataset(train = 'train', transform=train_transform, p_rot90 = 0.5, p_flipud = 0.5, p_fliplr = 0.5, patch_mode = 1)
trainloader = torch.utils.data.DataLoader(trainset, batch_size=TRAIN_BATCH_SIZE, shuffle = True)
testset = LOLDataset(train = 'test', transform=test_transform, p_rot90 = 0, p_flipud = 0, p_fliplr = 0, patch_mode = 0)
testloader = torch.utils.data.DataLoader(testset, batch_size=TEST_BATCH_SIZE, shuffle = True)
unknonwset = LOLDataset(train = 'unknown', transform=test_transform, p_rot90 = 0, p_flipud = 0, p_fliplr = 0, patch_mode = 0)
